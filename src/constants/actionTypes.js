...
* Player
*/
export const SET_INITIAL_PLAYER_DATA_REQUESTED = 'SET_INITIAL_PLAYER_DATA_REQUESTED';
export const SET_INITIAL_PLAYER_DATA_SUCCESS = 'SET_INITIAL_PLAYER_DATA_SUCCESS';
export const SET_INITIAL_PLAYER_DATA_FAILURE = 'SET_INITIAL_PLAYER_DATA_FAILURE';
